...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "be88c8c3c6a9b7fa0587";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (root, factory) {
    if (true) {
        ...
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! chartist */ "./node_modules/chartist/dist/chartist.js"), __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (chartist, jquery) {
...
var plugin_tooltip = __webpack_require__(/*! chartist-plugin-tooltip */ "./node_modules/chartist-plugin-tooltip/chartist-plugin-tooltip.js");
...
window.makeChartist = function (data) {
  ...
  */
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#data-plot").find(".ct-chart").remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#data-plot").append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>").addClass("ct-chart ct-major-eleventh"));
  var labels_days = [];
  var series_forecast = [];
  var series_deaths = [];

  for (var i = 0; i < data.days.length; i++) {
    labels_days.push(data.days[i].day); //series_forecast.push(data.days[i].data.forecast);
  ...
  var chartOptions = {
    ...
    plugins: [chartist__WEBPACK_IMPORTED_MODULE_1___default.a.plugins.tooltip()]
    /*
    ,
    'series-3': {
    	showPoint: false
  ...
  var DSIChart = new chartist__WEBPACK_IMPORTED_MODULE_1___default.a.Line(".ct-chart", chartData, chartOptions); // Let's put a sequence number aside so we can use it in the event callbacks

  var seq = 0,
      delays = 80,
      delays0 = 0,
      durations = 500,
      durations0 = 0; // Once the chart is fully created we reset the sequence
    ...
    if (data.type === "line") {
      ...
      data.element.animate({
        opacity: {
          ...
          to: 1,
          easing: chartist__WEBPACK_IMPORTED_MODULE_1___default.a.Svg.Easing.easeOutQuint
        }
      });
    }
    /*
...
function getDefaultCountry(arr_countrylist) {
  var default_country;

  try {
    var tmp = Intl.DateTimeFormat().resolvedOptions(); //var locale = tmp.locale;
